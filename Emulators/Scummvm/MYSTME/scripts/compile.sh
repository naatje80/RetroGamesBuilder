...
pacman -Suy --noconfirm libpipewire libpulse libglvnd cmake

git clone --depth 1 --branch ${LIBJPEGTURBOVERSION} https://github.com/libjpeg-turbo/libjpeg-turbo.git
cd libjpeg-turbo
